...
{
	btRigidBody rbA = *bodyA.body;
	btRigidBody rbB = *bodyB.body;

	const btVector3  anchorVecA = { anchorA.x ,anchorA.y , anchorA.z };
	const btVector3  anchorVecB = { anchorB.x ,anchorB.y , anchorB.z };
