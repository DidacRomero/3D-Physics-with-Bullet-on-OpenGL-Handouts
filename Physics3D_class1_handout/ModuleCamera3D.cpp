...
update_status ModuleCamera3D::Update()
{
	...
	{
		App->camera->Position.y += 0.1f;
		App->camera->Reference.y += 0.1f;
	}
	...
	{
		/*vec3 forward = { 0.1f,0.0f,0.0f };
		vec3* forwrd_pointer = &forward;
		App->camera->Position.x = forward_pointer * App->camera->X;*/
		App->camera->Z;
		App->camera->Position.y += 0.1f;
		App->camera->Reference.y += 0.1f;
	}
